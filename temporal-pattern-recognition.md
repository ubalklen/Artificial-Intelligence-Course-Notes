...
In such a model, we can suggest the next word in a text (a common feature of text processors) by answering "Given the sentence $W = w\_1, w\_2, \ldots, w\_n$, does what word $w\_{n+1}$ produce the sentence $W^* = w\_1, w\_2, \ldots, w\_n, w\_{n+1}$ with the highest $P(W^*)$?".
